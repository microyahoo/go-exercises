...
func (lim *Limiter) advance(now time.Time) (newNow time.Time, newLast time.Time, newTokens float64) {
	...
	// log.Printf("burst = %v, tokens = %v, maxElapsed = %v, elapsed = %v, last = %v",
	// 	lim.burst, lim.tokens, maxElapsed, elapsed, last)
	...
	// log.Printf("tokens = %v, limit.tokens = %v, last = %v, now = %v", tokens, lim.tokens, last, now)
